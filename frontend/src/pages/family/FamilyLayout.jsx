...
const navItems = [
  { label: "Dashboard", icon: "🏠", path: "/family" },
  { label: "My Patients", icon: "👴", path: "/family/patients" },
  { label: "Find Caregivers", icon: "🔍", path: "/family/caregivers" },
  { label: "Bookings", icon: "📅", path: "/family/bookings" },
